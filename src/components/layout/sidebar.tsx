...
const repLinks: NavItem[] = [
  ...
  { href: '/rep/sms', label: 'SMS OTPs', icon: MessageSquare, group: 'Work' },
...
const adminLinks: NavItem[] = [
  ...
  { href: '/admin/sms', label: 'SMS OTPs', icon: MessageSquare, group: 'Operations' },
  { href: '/admin/emails', label: 'Emails', icon: Mail, group: 'Operations' },
  { href: '/admin/platform-inbox', label: 'Office Inboxes', icon: Inbox, group: 'Operations' },
  ...
  { href: '/admin/reps/board', label: 'Rep board', icon: Activity, group: 'Records' },
  { href: '/admin/reps', label: 'Representatives', icon: Phone, group: 'Records' },
  { href: '/admin/payroll', label: 'Payroll', icon: Wallet, group: 'Business' },
